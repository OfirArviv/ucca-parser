...
def collate_fn(data):
    subword_idxs, subword_masks, token_starts_masks, lang_idx, word_idx, pos_idx, dep_idx, ent_idx, ent_iob_idx, passages, trees, all_nodes, all_remote, projection_instances = zip(*data)
    return (
